...
LOCAL_APPS = [
    ...
    "app.enterprise.apps.EnterpriseConfig",
    "app.conference.apps.ConferenceConfig",
    "app.metric.apps.MetricConfig",
...
ADMINS = [("""Renier Ricardo Figueredo""", "aprezcuba24@gmail.com")]
...
REST_FRAMEWORK = {
    ...
    "EXCEPTION_HANDLER": "app.utils.custom_exception_handler.exception_handler",
}
...
GROUP_UPLOAD_FILES = env("GROUP_UPLOAD_FILES")

IMAGE_FOLDER = "uploads/conferences/images"
AUDIO_FOLDER = "uploads/conferences/voice"
